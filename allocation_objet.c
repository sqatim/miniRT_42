...
/*   Updated: 2020/11/13 14:37:11 by sqatim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void trans_rot(t_data *type, t_objet *new_object, t_info object)
{
    ...
    {
        new_object->translation = x_y_z(object.translation[0], object.translation[1], object.translation[2]);
        new_object->pos = vector_add(new_object->pos, new_object->translation);
        if (type->tool.tran_rot == 2)
        {
            new_object->rotation = x_y_z(object.rotation[0], object.rotation[1], object.rotation[2]);
...
t_objet *add_sphere(t_data *type, t_info object)
{
    ...
    new_sphere->colour = make_range(r_g_b(object.colour[0], object.colour[1], object.colour[2]));
...
t_objet *add_plane(t_data *type, t_info object)
{
    ...
    new_plane->colour = make_range(r_g_b(object.colour[0], object.colour[1], object.colour[2]));
...
t_objet *add_square(t_data *type, t_info object)
{
    ...
    new_square->colour = make_range(r_g_b(object.colour[0], object.colour[1], object.colour[2]));
